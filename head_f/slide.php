                  ...
                  <div id="carouselId" class="carousel slide my-2" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                      <div class="carousel-item embed-responsive-item active">
                        <img src="img/slide-img/banner4.jpg" alt="First slide image" class="img-fluid">
                      ...
                      <div class="carousel-item embed-responsive-item">
                        <img src="img/slide-img/banner3.jpg" alt="Third slide image" class="img-fluid" width="100%">
                      
                      </div>
                      <div class="carousel-item embed-responsive-item">
                        <img src="img/slide-img/hoc-tieng-han.png" alt="four slide image" class="img-fluid" width="100%">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                              <div class="row conten-contact">
                                ...
                                <div class="col-md-10 text-contact-bar">
                                  <p>E-mail</p>
                                  <p>Ieducenter@thanhdong.edu.vn</p>
                                </div>
                              </div>
                        </div>
                      </div>
