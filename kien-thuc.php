                                            ...
                                            <?php 
                                                ...
                                                <li class="list-group-item p-2"  style="background: #fefefe;">
                                                        <div class="large" >
                                                            ...
                                                            <p class="date-time hidden-xs hidden-sm"><i class="fa fa-calendar" aria-hidden="true"></i> <span>11-09-2022</span>
                                                            </p
                                                                <p style="font-size:15px"><?php echo $row['TomTat']; ?></p>
                                                                <p><strong> 
                                                                    <a class="lienket" href="<?= $row['url']; ?>" target="_blank"><span style="color:#ffffff;">Tải Sách</span></a>                                                               
                                                                </strong></p>
                                                            </div>
                                                        </div>
